...
var regular_speech_p : Array = [
	...
	":)",
	"What does the sad face looks like?",
...
var regular_speech_e : Array = [
	"You are about to become our meal tomorrow, \nbe quiet!",
	"What's the smile for? You should be sad.",
	"Sad face is...",
	"Good, good, this is the face you should \nhave.",
	"Hahahaha(the shrink keeps smiling)",
	"Sure, take a walk before you die."
];

var wrong_speech_e : Array = [
	"You think it's funnly?",
	"......",
	"",
	"???"
];
...
function Update () {
	if(Input.GetKeyDown("return")) {
		switch (progress) {
			case 1: showEnemyStf (true); enemySpk(); break;
			case 2: playerSpk(); break;
			case 3: enemySpk(); break;
			case 4: playerSpk(); break;
			case 5: enemySpk(); break;
			
			case 6: setOptions(options1); showOptions(true); break;
			case 7: chooseOption(options1); break;
			
			case 8: playerSpk(); break;
			case 9: enemySpk(); break;
			case 10: playerSpk(); break;
			case 11: enemySpk(); break;
			
			case 12: doorOpen(); break;
			case 13: walkInside(); break;

...
var regular_speech_e : Array = [
	"(Roro feels dangerous while entering this room)",
	"You are Roro right? I heard a lot about \nyou.",
	"After me, you will face a lot of \nchallenges.",
	"(Sea horse sigh)",
	"(Sea horse sigh again)",
	"You will face Bettafish sisters, you have \nto beat them to move forward.",
	"Use the emoji you have learned.",
	"(Sea horse left)"
];

var wrong_speech_e : Array = [
	"Are you kidding me?",
	"You are about to die, what's the smile for?",
	"",
	"???"
];
